<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qrcyc.aspx.cs" Inherits="QRMobi.Webcyc" %>
...
<body style="height: 589px; width: 1199px">
    ...
    <br />
        ...
        <br />
    <table id="tCode0" class="auto-style1" align="center">
        <tr>
            <td class="style67">
                </td>
            <td class="style50">
        ...
        <tr>
            ...
            <td id="" class="style68">
                <asp:TextBox ID="tbFrameNo" runat="server" Width="342px" ReadOnly="True" 
                    CssClass="style29" BorderStyle="None" Height="30px" ></asp:TextBox>
            </td>
        </tr>
        <tr>
