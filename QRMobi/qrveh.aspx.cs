...
namespace QRMobi
{
    public partial class Webveh : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //http://www.datatag.mobi/qrveh.aspx?id=DT01B9YB2B&code=308139188
            ...
            if (key != "" && key != null)
            {
                ...
                if (found)
                {
                    //Temp
                    reader.Close();
                    Response.Redirect("~/Pages/NotFoundVeh.aspx?ini=" + iniFile);
                ...
                else
                {
                    ...
                    string msg = "QR Scan from Cesar Micro (Veh) using ID:" + key + " Code:" + code + " was not located";
